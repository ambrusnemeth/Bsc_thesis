...
t1 = np.linspace(0, 6000, num=2000)
t2 = np.linspace(0, 1440, num=2000)

t = np.linspace(0, 6000, num=2000)
...
theta_2 = 0             # relative contribution of I1 to Hes1 transcription upregulation
m_2 = 3                 # Hill coefficient for the Hill function for I_2
kappa_2 = 0.9           # dissociation constant for the Hill function for I_2
theta_7 = 1             # relative contribution of B to Hes1 transcription upregulation
...
plt.ylabel("β-cat")
plt.title("$θ_2$="+str(params[10]))
plt.plot(tt1, y[:,9], 'k')
plt.plot(tt1, y[:,21], 'k:')
plt.ylim([0, 250])

y = odeint(sim,y0,t2,args=(params,))
...
params[30] = 2
y = odeint(sim,y0,t1,args=(params,))
fig.add_subplot(6,4,18)
plt.plot(tt1, y[:,9], 'b')
plt.plot(tt1, y[:,21], 'b:')
plt.ylim([0, 250])

y = odeint(sim,y0,t2,args=(params,))
fig.add_subplot(6,4,22)
plt.plot(tt2, y[:,3], 'b')
plt.plot(tt2, y[:,15], 'b:')
plt.ylim([0, 6])
...
params[30] = 2
y = odeint(sim,y0,t1,args=(params,))
fig.add_subplot(6,4,19)
plt.plot(tt1, y[:,9], 'b')
plt.plot(tt1, y[:,21], 'b:')
plt.ylim([0, 250])

y = odeint(sim,y0,t2,args=(params,))
fig.add_subplot(6,4,23)
plt.plot(tt2, y[:,3], 'b')
plt.plot(tt2, y[:,15], 'b:')
plt.ylim([0, 6])
...
params[30] = 2
y = odeint(sim,y0,t1,args=(params,))
fig.add_subplot(6,4,20)
plt.plot(tt1, y[:,9], 'b')
plt.plot(tt1, y[:,21], 'b:')
plt.ylim([0, 250])

y = odeint(sim,y0,t2,args=(params,))
fig.add_subplot(6,4,24)
plt.plot(tt2, y[:,3], 'b')
plt.plot(tt2, y[:,15], 'b:')
plt.ylim([0, 6])
